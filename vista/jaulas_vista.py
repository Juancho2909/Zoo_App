...
class JaulasVista:
    def __init__(self,controlador):
        ...
        self.ventana = tk.Tk()
        self.ventana.title("Jaulas")
        self.ventana.geometry("600x400")
        self.ventana.configure(bg="lightgreen")
        self.ventana.attributes("-fullscreen", True)

        etiqueta = tk.Label(self.ventana, text="Jaulas", font=("Helvetica", 20), bg="lightblue")
        etiqueta.pack(pady=20)
   
        # Configuración de la tabla
        self.tabla = ttk.Treeview(self.ventana, columns=("idjaula", "tamano"), show="headings")
    ...
    def cargar_datos(self, datos_jaulas):
        ...
        for jaula in datos_jaulas:
            self.tabla.insert("", "end", values=jaula)
