...
class ModeloArticulos:
    ...
    def obtener_todos_los_articulos(self, correo, licencia):
        """Obtiene todos los artículos relacionados con las jaulas."""
        try:
            ...
            query = "SELECT * FROM articulos WHERE idjaula IN (%s)" % ','.join(['%s'] * len(idjaulas))
